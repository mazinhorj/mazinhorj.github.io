...
// Form multi v2
const cardBtnForm2 = document.querySelector("#card_form2 i");
const cardForm2 = document.querySelector("#cont_form2");

const abreFechaForm2 = (e) => {
  cardBtnForm2.classList.toggle("spin");
  cardForm2.classList.toggle("esconde");
};

cardBtnForm2.addEventListener("click", (e) => {
  abreFechaForm2();
});
...
// Git buscador
const cardBtnGit = document.querySelector("#card_git i");
const cardGit = document.querySelector("#cont_git");

const abreFechaGit = (e) => {
  cardBtnGit.classList.toggle("spin");
  cardGit.classList.toggle("esconde");
};

cardBtnGit.addEventListener("click", (e) => {
  abreFechaGit();
});
...
// Promessas
const cardBtnCaixinha = document.querySelector("#card_caixinha i");
const cardCaixinha = document.querySelector("#cont_caixinha");

const abreFechaCaixinha = (e) => {
  cardBtnCaixinha.classList.toggle("spin");
  cardCaixinha.classList.toggle("esconde");
};

cardBtnCaixinha.addEventListener("click", (e) => {
  abreFechaCaixinha();
});
...
// Postits
const cardBtnPostits = document.querySelector("#card_postits i");
const cardPostits = document.querySelector("#cont_postits");

const abreFechaPostits = (e) => {
  cardBtnPostits.classList.toggle("spin");
  cardPostits.classList.toggle("esconde");
};

cardBtnPostits.addEventListener("click", (e) => {
  abreFechaPostits();
});
...
// Lazy
const cardBtnLazy = document.querySelector("#card_lazy i");
const cardLazy = document.querySelector("#cont_lazy");

const abreFechaLazy = (e) => {
  cardBtnLazy.classList.toggle("spin");
  cardLazy.classList.toggle("esconde");
};

cardBtnLazy.addEventListener("click", (e) => {
  abreFechaLazy();
});
...
// iphone
const cardBtnIphone = document.querySelector("#card_iphone i");
const cardIphone = document.querySelector("#cont_iphone");

const abreFechaIphone = (e) => {
  cardBtnIphone.classList.toggle("spin");
  cardIphone.classList.toggle("esconde");
};

cardBtnIphone.addEventListener("click", (e) => {
  abreFechaIphone();
});
